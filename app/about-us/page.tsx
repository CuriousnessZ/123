    ...
    <main className="bg-[#fbf8f4]">
      <section className="relative min-h-[85vh] overflow-hidden bg-stone-950 text-white">
        <video
          ...
          playsInline
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(10,10,10,0.2),rgba(10,10,10,0.85))]" />
        ...
        <div className="relative mx-auto flex min-h-[85vh] w-full max-w-7xl items-center px-5 py-20 md:px-8">
          <div className="max-w-4xl space-y-8">
            ...
            <p className="max-w-2xl text-base leading-8 text-white/72 md:text-xl">
              {t(
