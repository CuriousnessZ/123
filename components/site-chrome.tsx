    ...
    <footer className="border-t border-stone-200 bg-[#f5efe8]">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 py-14 md:grid-cols-[1.1fr_0.9fr] md:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          <div>
            <p className="mb-4 text-sm font-semibold text-stone-900">Navigation</p>
          ...
          <div>
            <p className="mb-4 text-sm font-semibold text-stone-900">Connect</p>
            <div className="space-y-3 text-sm text-stone-600">
              ...
              <p>Certifications: OEKO-TEX, GOTS, ISO9001, BSCI</p>
              <p>Copyright {new Date().getFullYear()} Premium Home Textiles</p>
            </div>
          </div>
        </div>
      </div>
...
export function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      <span className="hidden sm:inline">Chat With Textile Specialist</span>
